                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="contactNumber" class="form-control" value="{{ old('contactNumber',$user->contact_no)}}" name="contactNumber" maxlength="13">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="employee_id" class="form-control" value="{{ old('employee_id',$user->employee_id)}}" name="employee_id" placeholder="EMP-242010" maxlength="12">
